...
AS
	...
	left join dbo.dimlocations on [v_TaxiRequestersBasicInfo].locationid = dimlocations.webportallocationid
	left join dbo.dimdepartments on [v_TaxiRequestersBasicInfo].departmentid = dimdepartments.webportaldepartmentid
